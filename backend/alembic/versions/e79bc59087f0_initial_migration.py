...
def upgrade() -> None:
    ...
    sa.Column('outlet', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('publication_date', sa.Date(), nullable=False),
    sa.Column('contribution', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_publication_title'), 'publication', ['title'], unique=False)
