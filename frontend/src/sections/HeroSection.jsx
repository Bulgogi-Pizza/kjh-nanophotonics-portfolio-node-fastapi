        ...
        <div className="relative container mx-auto px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              {/* 배지 */}
              <div
                  className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300">
                <div
              ...
              <div className="flex flex-wrap gap-3">
                {['Nanophotonics', 'Metamaterials', 'Holography',
                  'Energy Solutions'].map((keyword) => (
                    <span
                        key={keyword}
                        className="px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full border border-gray-200 dark:border-gray-700 text-sm font-medium hover:border-blue-300 dark:hover:border-blue-600 transition-colors"
                    >
                  {keyword}
                </span>
                ))}
            ...
            <div className="relative">
              ...
              {/* 장식 요소 */}
              <div
                  className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-blue-400/20 to-indigo-400/20 rounded-full blur-xl"></div>
              <div
                  className="absolute -bottom-8 -left-8 w-32 h-32 bg-gradient-to-br from-indigo-400/20 to-blue-400/20 rounded-full blur-xl"></div>
            </div>
          </div>
        </div>
      </section>
