...
export default function CoverArtsTab({items = [], onUpdate}) {
  ...
  const createItem = async (e) => {
    ...
    await fetch("/api/cover-arts/", {
      ...
      body: JSON.stringify({
        ...
        year: form.year || null, // 백엔드에서 str 허용
  ...
  return (
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Cover
          Arts</h2>
        ...
        <form onSubmit={createItem}
          ...
          <div className="space-y-2 md:col-span-3">
            ...
            {form.image_path && (
                <img src={form.image_path} alt="preview"
              ...
              <div key={it.id}
                ...
                <div className="flex-1">
                  <div className="font-medium">
                    <span className="font-bold italic">{it.journal}</span>
                    {it.volume && <span
                        className="font-bold">, {it.volume}</span>}
